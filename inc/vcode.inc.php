<?php
function vcode($width=120,$height=35,$fontSize=30,$countElement=5,$countPixel=100,$countLine=4){
	...
	imagettftext($img,$fontSize,rand(-5,5),rand(5,15),rand(30,32),$colorString,'font/ManyGifts.ttf',$string);
	imagejpeg($img);
	imagedestroy($img);
	return $string;
}
